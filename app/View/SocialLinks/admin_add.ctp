		...
		<div class="box-tools pull-right">
			<div class="btn-group">
				...
				<div class="btn-group hidden-nav-xs">
					<?php echo $this->Html->link(__('Ad List'), array('action' => 'index'),array('class' => 'btn btn-sm btn-default ajax_page')); ?>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="col-lg-12 col-xs-12 col-md-12 col-sm-12">
		<div class="box box-solid box-primary">
			<div class="box-header">
				<h3 class="box-title"><?php echo __('SocialLink'); ?>
</h3>
				<div class="box-tools pull-right">
			...
			<div class="box-body">
				<div class="row">
						<?php echo $this->Form->create('SocialLink',array('role'=>'form','type'=>'file')); ?>
						<?php
