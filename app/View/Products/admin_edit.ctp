...
<div class="row">
	<div class="col-lg-12 col-xs-12 col-md-12 col-sm-12">
		<div class="box box-solid box-primary">
				...
				<div class="row">
						...
						<?php
							...
							if(!empty($this->data['Product']['image'])){
								$news_image = $this->data['Product']['image'];
							} 
						?>	
						...
						<?php
						   echo $this->Form->input('pre_image',array('type'=>'hidden','value'=>$this->data['Product']['image']));
			...
			echo $this->Form->input('category_id',array('empty'=>'Please Select','class'=>'form-control','div'=>'form-group col-md-3','required'=>true,'label'=>'Category','options'=>$parentCategories));
