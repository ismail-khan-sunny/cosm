...
<div class="row">
	<div class="col-lg-12 col-xs-12 col-md-12 col-sm-12">
		<div class="box box-solid box-primary">
			...
			<div class="box-body">
				<div class="row">
					<?php echo $this->Form->create('Product',array('type'=>'file','role'=>'form','class'=>'')); ?>	<div class="col-md-2 display-image hover-cross">
					...
					echo $this->Form->input('image',array('type'=>'file','onchange'=>'displayImage(this,"newsAvaterImage")','id'=>'uploadImage','div'=>'form-group col-md-10','required'=>true));										
					...
					echo $this->Form->input('title',array('class'=>'form-control','div'=>'form-group col-md-6','label'=>'Product Name'));
					
					?>
					<?php
					
					echo $this->Form->input('description',array('class'=>'form-control','div'=>'form-group col-md-12','label'=>'Specification'));
