...
<div class="row">
	<div class="col-lg-12 col-xs-12 col-md-12 col-sm-12">
		<div class="box box-solid box-primary">
			...
			<div class="box-body">
				<div class="row">
						<?php echo $this->Form->create('Product',array('role'=>'form','class'=>'')); ?>
						<?php
			...
			echo $this->Form->input('company_id',array('class'=>'form-control','div'=>'form-group col-md-12'));
			...
			echo $this->Form->input('pack_size',array('class'=>'form-control','div'=>'form-group col-md-12'));
			echo $this->Form->input('carton_size',array('class'=>'form-control','div'=>'form-group col-md-12'));
