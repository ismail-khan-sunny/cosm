	...
	<div class="col-lg-12 col-xs-12 col-md-12 col-sm-12">
		<div class="box box-solid box-primary">
			<div class="box-header">
				<h3 class="box-title"><?php echo __('Service'); ?></h3>
				<div class="box-tools pull-right">
			...
			<div class="box-body">
				<div class="row">
						<?php echo $this->Form->create('Mission',array('type'=>'file','role'=>'form','class'=>'')); ?>
						<?php
						
							$news_image = 'no-image.png';
							if(!empty($this->data['Mission']['image'])){
								$news_image = $this->data['Mission']['image'];
							} 
						?>	
						<div class="col-md-2 display-image hover-cross">
							<?php echo $this->Html->image($news_image,array('class'=>'img-responsive','id'=>'newsAvaterImage','width'=>'150')) ?>
							<span onclick="removeImageSrc('newsAvaterImage','uploadImage','NewsPreImage')"><i class="fa fa-fw fa-times-circle"></i></span>
							
						</div>							
						<?php echo $this->Form->input('id',array('type'=>'hidden')); ?>
					
						<?php
							echo $this->Form->input('pre_image',array('type'=>'hidden','value'=>$this->data['Mission']['image']));
							echo $this->Form->input('image',array('type'=>'file','onchange'=>'displayImage(this,"newsAvaterImage")','id'=>'uploadImage','div'=>'form-group col-md-10','required'=>false));
							echo $this->Form->input('company_id',array('empty'=>'Please Select','class'=>'form-control','div'=>'form-group col-md-5'));
							echo $this->Form->input('title',array('class'=>'form-control','div'=>'form-group col-md-6','label'=>'Title'));
...
<?php 
	...
	echo $this -> Html -> script('admin/nogoradmin/Mission');
?>
