	...
	<div class="col-lg-12 col-xs-12 col-md-12 col-sm-12 margin-bottom-10">
		<div class="box-tools pull-right">
			...
			<div class="btn-group">
				...
				<div class="btn-group hidden-nav-xs">
					<?php echo $this->Html->link(__('Add New Service'), array('action' => 'add'),array('class' => 'btn btn-sm btn-primary')); ?>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="box box-solid box-primary">
			...
			<div class="box-body">
				<div class="row">
						...
						<table class="table table-striped table-bordered dataTable">
							<thead>
								<tr>
																			...
																			<th><?php echo $this->Paginator->sort('company_id', null, array('class'=>'')); ?></th>
					...
					<tr>
						<td><?php echo h($sl); ?>&nbsp;</td>
						<td><?php echo $this->Html->Image($mission['Mission']['image'],array('width'=>'120')); ?>&nbsp;</td>
						<td><?php echo h($mission['Mission']['title']); ?>&nbsp;</td>
						<td><?php echo ($mission['Mission']['description']); ?>&nbsp;</td>
						
						
						<td><?php echo h($mission['Mission']['status']); ?>&nbsp;</td>
						<td><?php echo h($mission['Company']['title']); ?>&nbsp;</td>
