	...
	<div class="col-lg-12 col-xs-12 col-md-12 col-sm-12 margin-bottom-10">
		<div class="box-tools pull-right">
			...
			<div class="btn-group">
				...
				<div class="btn-group hidden-nav-xs">
					<?php echo $this->Html->link(__('Add New Download'), array('action' => 'add'),array('class' => 'btn btn-sm btn-primary')); ?>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="col-lg-12 col-xs-12 col-md-12 col-sm-12">
		<div class="box box-solid box-primary">
			<div class="box-header">
				<h3 class="box-title"><?php echo __('Downloads'); ?>
</h3>
				<div class="box-tools pull-right">
				...
				<div class="row">
					<div class="col-lg-12 col-xs-12 col-md-12 col-sm-12">
						<table class="table table-striped table-bordered dataTable">
							...
							<tbody>
								<?php $sl = $this->Paginator->counter('{:start}'); foreach ($downloads as $download): ?>
					<tr>
						<td><?php echo h($sl); ?>&nbsp;</td>
						<td><?php echo h($download['Download']['category']); ?>&nbsp;</td>
						<td><?php echo h($download['Download']['type']); ?>&nbsp;</td>
						<td><?php echo h($download['Download']['title']); ?>&nbsp;</td>
						<td><?php echo h($download['Download']['description']); ?>&nbsp;</td>
						<td><?php echo h($download['Download']['image']); ?>&nbsp;</td>
						<td><?php echo h($download['Download']['file']); ?>&nbsp;</td>
						<td><?php echo h($download['Download']['status']); ?>&nbsp;</td>
						<td><?php echo h($download['Download']['created']); ?>&nbsp;</td>
						<td><?php echo h($download['Download']['slug']); ?>&nbsp;</td>
						<td><?php echo h($download['Download']['start_date']); ?>&nbsp;</td>
						<td><?php echo h($download['Download']['end_date']); ?>&nbsp;</td>
						<td><?php echo h($download['Download']['meta_keyword']); ?>&nbsp;</td>
						<td><?php echo h($download['Download']['meta_description']); ?>&nbsp;</td>
						<td>
							<?php echo $this->Html->link('<i class="fa fa-eye"></i> ', array('action' => 'view', $download['Download']['id']),array('class'=>'btn btn-rounded btn-sm btn-icon btn-primary', 'escape'=>false)); ?>
							<?php echo $this->Html->link('<i class="fa fa-edit"></i> ', array('action' => 'edit', $download['Download']['id']),array('class'=>'btn btn-rounded btn-sm btn-icon btn-info','escape'=>false)); ?>
							<?php //echo $this->Html->link('<i class="fa fa-times text-white text"></i> ', array('action' => 'delete', $download['Download']['id']),array('class'=>'btn btn-rounded btn-sm btn-icon btn-danger ajax_delete', 'escape'=>false)); ?>
							<?php echo $this->Form->postLink('<i class="fa fa-times text-white text"></i>', array('action' => 'delete', $download['Download']['id']), array('class'=>'btn btn-rounded btn-sm btn-icon btn-danger', 'escape'=>false), __('Are you sure?')); ?>
						</td>
					</tr>
					<?php $sl++; endforeach; ?>
							</tbody>
