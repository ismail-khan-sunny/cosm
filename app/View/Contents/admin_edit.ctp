		...
		<div class="box box-solid box-primary">
			...
			<div class="box-body">
				...
				<?php
					...
					if($this->data['Content']['id']=='58bfe95a-345c-4c5a-b57a-5c78f8defb25'){
						$width_ration="image(370X240)";
					}
				...
				<div class="col-md-2 display-image hover-cross">
					<?php echo $this->Html->image($content_image,array('class'=>'img-responsive','id'=>'contentAvaterImage','width'=>'150')) ?>
					<span onclick="removeImageSrc('contentAvaterImage','uploadImage','ContentPreImage')"><i class="fa fa-fw fa-times-circle"></i></span>
				</div>
				<?php
					echo $this->Form->input('id');
					echo $this->Form->hidden('pre_image',array('value'=>$this->request->data['Content']['image']));
				...
				<div>
					...
					<?php 
						...
						if(!empty($this->request->data['Content']['meta_keyword']) || !empty($this->request->data['Content']['meta_description'])){
							$hidden = '';
						} 
					?>
