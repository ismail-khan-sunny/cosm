...
<div class="row">
	<div class="col-lg-12 col-xs-12 col-md-12 col-sm-12">
		...
		echo $this->Form->input('url',array('class'=>'form-control','div'=>array('class'=>'form-group col-md-6 menu-url')));
						...
						echo $this->Form->hidden('pre_file',array('class'=>'','div'=>'form-group ','value'=>$this->request->data['Menu']['file']));
