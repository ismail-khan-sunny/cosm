		...
		<div class="box box-solid box-primary">
			...
			<div class="box-body">
				...
				<div class="col-md-2 display-image hover-cross">
					<?php echo $this->Html->image('no-image.png',array('class'=>'img-responsive','id'=>'serviceAvaterImage','width'=>'150')) ?>
					<span onclick="removeImageSrc('serviceAvaterImage','uploadImage')"><i class="fa fa-fw fa-times-circle"></i></span>
				</div>
				<?php
