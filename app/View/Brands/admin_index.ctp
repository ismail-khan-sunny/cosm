	...
	<div class="col-lg-12 col-xs-12 col-md-12 col-sm-12 margin-bottom-10">
		<div class="box-tools pull-right">
			...
			<div class="btn-group">
				...
				<div class="btn-group hidden-nav-xs">
					<?php echo $this->Html->link(__('Add New Brand'), array('action' => 'add'),array('class' => 'btn btn-sm btn-primary')); ?>
				</div>
			</div>
		</div>
	</div>
				...
				<div class="row">
					<div class="col-lg-12 col-xs-12 col-md-12 col-sm-12">
						<table class="table table-striped table-bordered dataTable">
							...
							<tbody>
								<?php $sl = $this->Paginator->counter('{:start}'); foreach ($brands as $brand): ?>
					<tr>
						<td><?php echo h($sl); ?>&nbsp;</td>
						...
						<td>
							<?php 
								if(!empty($brand['Brand']['image'])){
									echo $this->Html->image($brand['Brand']['image'],array('class'=>'img-responsive','width'=>'150')); 
								}
							?>&nbsp;
						...
						<td>
							<?php echo $this->Html->link('<i class="fa fa-eye"></i> ', array('action' => 'view', $brand['Brand']['id']),array('class'=>'btn btn-rounded btn-sm btn-icon btn-primary', 'escape'=>false)); ?>
							<?php echo $this->Html->link('<i class="fa fa-edit"></i> ', array('action' => 'edit', $brand['Brand']['id']),array('class'=>'btn btn-rounded btn-sm btn-icon btn-info','escape'=>false)); ?>
							<?php //echo $this->Html->link('<i class="fa fa-times text-white text"></i> ', array('action' => 'delete', $brand['Brand']['id']),array('class'=>'btn btn-rounded btn-sm btn-icon btn-danger ajax_delete', 'escape'=>false)); ?>
							<?php echo $this->Form->postLink('<i class="fa fa-times text-white text"></i>', array('action' => 'delete', $brand['Brand']['id']), array('class'=>'btn btn-rounded btn-sm btn-icon btn-danger', 'escape'=>false), __('Are you sure?')); ?>
						</td>
					</tr>
					<?php $sl++; endforeach; ?>
							</tbody>
