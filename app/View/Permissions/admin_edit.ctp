...
<section class="bg-white scrollable wrapper">
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<?php
				echo $this->Form->input('Permission.role_id',array('type'=>'select','value'=>$role_id,'class'=>'form-control','div'=>'form-group col-md-6'));
			?>
				...
				<tr>
					...
					<td>
						...
						<label class="checkbox process-label">
							<?php 
								$checked = '';
								if($this->Custom->getProcessData($this->data,$role_id,$dominion['Dominion']['id'],$process['id'])){
									$checked = 'checked';
									echo $this->Form->input($sl.'.Dominion.process.'.$i.'.process_id',array('type'=>'checkbox','value'=>$process['id'],'checked'=>'checked','label'=>false,'div'=>false));
								}else{
									echo $this->Form->input($sl.'.Dominion.process.'.$i.'.process_id',array('type'=>'checkbox','value'=>$process['id'],'label'=>false,'div'=>false));
								}
							?>
