		...
		<div class="box-tools pull-right">
			<div class="btn-group">
				...
				<div class="btn-group hidden-nav-xs">
					<?php echo $this->Html->link(__('List Slider Content'), array('action' => 'index',$slider_id),array('class' => 'btn btn-sm btn-primary')); ?>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="box-body">
				<div class="row">
					...
					<?php
						...
						echo $this->Form->hidden('pre_image',array('type'=>'file','value'=>''));
						echo $this->Form->input('image',array('type'=>'file','div'=>'form-group col-md-12','id'=>'uploadImage','required'=>true,'label'=>'image(1440X645)'));
						echo $this->Form->input('slider_id',array('type'=>'hidden', 'value'=>$slider_id));
