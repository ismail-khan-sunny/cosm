...
<div class="row">
	<div class="col-lg-12 col-xs-12 col-md-12 col-sm-12">
		<div class="box box-solid box-primary">
			...
			<div class="box-body">
				<div class="row">
						<?php echo $this->Form->create('Category',array('type'=>'file','role'=>'form','class'=>'')); 
			echo $this->Form->input('id',array('class'=>'form-control','div'=>'form-group col-md-12'));
			echo $this->Form->input('parent_id',array('class'=>'form-control','div'=>'form-group col-md-4','options'=>$parentCategories,'empty'=>'Please Select'));
			echo $this->Form->input('title',array('class'=>'form-control','div'=>'form-group col-md-8'));
