	...
	<div class="col-lg-12 col-xs-12 col-md-12 col-sm-12 margin-bottom-10">
		<div class="box-tools pull-right">
			...
			<div class="btn-group">
				...
				<div class="btn-group hidden-nav-xs">
					<?php echo $this->Html->link(__('New Photo Gallery'), array('action' => 'add'),array('class' => 'btn btn-sm btn-primary')); ?>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="col-lg-12 col-xs-12 col-md-12 col-sm-12">
		<div class="box box-solid box-primary">
			<div class="box-header">
				<h3 class="box-title"><?php echo __('Photo Albums List'); ?></h3>
				<div class="box-tools pull-right">
				...
				<table class="table table-striped table-bordered  table-hover">
					<thead>
						<tr>
	                        ...
	                        <th><?php echo $this->Paginator->sort('Album Content', null, array('class'=>'')); ?></th>
	                    	<th><i class="fa fa-cog"></i></th>
						</tr>
					</thead>
					<tbody>
						<?php $sl= $this->Paginator->counter('{:start}'); foreach ($photoGalleries as $photoGallery): ?>
						<tr>
							<td><?php echo h($sl); ?>&nbsp;</td>
							<td><?php echo h($photoGallery['PhotoGallery']['title']); ?>&nbsp;</td>
	                        <td><?php echo $this->Html->Image($photoGallery['PhotoGallery']['image']); ?>&nbsp;</td>
							<td><?php
							$created = strtotime($photoGallery['PhotoGallery']['created']);	
							echo h(date("jS F Y", $created));	?>&nbsp;

							</td>
							<td><?php echo h($photoGallery['PhotoGallery']['status']); ?>&nbsp;</td>
	                        <td>
	                        <?php echo $this->Html->link(
									'<i class="fa fa-plus"></i> Manage Photo', 
									array(
										'controller'=>'Photos', 
										'action' => 'index', 
										$photoGallery['PhotoGallery']['id'],$photoGallery['PhotoGallery']['title']
										),
									array(
							...
							<td>
								<?php echo $this->Html->link('<i class="fa fa-edit"></i> ', array('action' => 'admin_edit', $photoGallery['PhotoGallery']['id']),array('class'=>'btn btn-rounded btn-sm btn-icon btn-info', 'escape'=>false)); ?>
								<?php echo $this->Form->PostLink('<i class="fa fa-times text-white text"></i> ', array('action' => 'admin_delete', $photoGallery['PhotoGallery']['id']),array('class'=>'btn btn-rounded btn-sm btn-icon btn-danger ajax_delete', 'escape'=>false),__('Are you sure?')); ?>
							</td>
						</tr>
						<?php $sl++; endforeach; ?>
					</tbody>
