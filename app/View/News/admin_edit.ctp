				...
				<div class="row">
						...
						<?php
							...
							if(!empty($this->data['News']['image'])){
								$news_image = $this->data['News']['image'];
							} 
						?>
						<div class="col-md-2 display-image hover-cross">
							...
							<?php
								echo $this->Form->input('pre_image',array('type'=>'hidden','value'=>$this->data['News']['image']));
							echo $this->Form->input('image',array('type'=>'file','class'=>'','div'=>'form-group col-md-col-md-10','id'=>'uploadImage'));
							?>
						</div>
						...
						<?php
							...
							echo $this->Form->input('pre_file',array('type'=>'hidden','value'=>$this->data['News']['file']));
					...
					<?php 
						...
						if(!empty($this->request->data['News']['meta_keyword']) || !empty($this->request->data['News']['meta_description'])){
							$hidden = '';
						} 
					?>
