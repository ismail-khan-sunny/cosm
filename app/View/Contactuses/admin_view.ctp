...
<div class="row">
	...
	<tr>
		...
		<td>
			<?php echo h($contactus['Contactus']['mobile']); ?>
			&nbsp;
		</td>
	</tr>
	<tr>
		...
		<td>
			<?php echo h($contactus['Contactus']['fax']); ?>
			&nbsp;
		</td>
	</tr>	
	<tr>
		...
		<td>
			<?php echo ($contactus['Contactus']['description']); ?>
			&nbsp;
		</td>
	</tr>

	<tr>
		<td><?php echo __('Google Location'); ?></td>
		<td>
			<?php echo ($contactus['Contactus']['google_location']); ?>
			&nbsp;
		</td>
	</tr>
	<tr>
