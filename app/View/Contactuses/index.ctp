	...
	<div class="col-lg-12 col-xs-12 col-md-12 col-sm-12 margin-bottom-10">
		<div class="box-tools pull-right">
			...
			<div class="btn-group">
				...
				<div class="btn-group hidden-nav-xs">
					<?php echo $this->Html->link(__('Add New Contactus'), array('action' => 'add'),array('class' => 'btn btn-sm btn-primary')); ?>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="box box-solid box-primary">
			...
			<div class="box-body">
				<div class="row">
					...
					<tr>
						<td><?php echo h($sl); ?>&nbsp;</td>
						<td><?php echo h($contactus['Contactus']['category']); ?>&nbsp;</td>
						<td><?php echo h($contactus['Contactus']['type']); ?>&nbsp;</td>
						<td><?php echo h($contactus['Contactus']['title']); ?>&nbsp;</td>
						<td><?php echo h($contactus['Contactus']['description']); ?>&nbsp;</td>
						<td><?php echo h($contactus['Contactus']['image']); ?>&nbsp;</td>
						<td><?php echo h($contactus['Contactus']['file']); ?>&nbsp;</td>
						<td><?php echo h($contactus['Contactus']['status']); ?>&nbsp;</td>
						<td><?php echo h($contactus['Contactus']['created']); ?>&nbsp;</td>
						<td><?php echo h($contactus['Contactus']['slug']); ?>&nbsp;</td>
						<td><?php echo h($contactus['Contactus']['start_date']); ?>&nbsp;</td>
						<td><?php echo h($contactus['Contactus']['end_date']); ?>&nbsp;</td>
