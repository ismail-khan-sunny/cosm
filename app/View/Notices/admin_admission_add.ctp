		...
		<div class="box-tools pull-right">
			<div class="btn-group">
				...
				<div class="btn-group hidden-nav-xs">
					<?php echo $this->Html->link(__('Admission List'), array('action' => 'admission_view'),array('class' => 'btn btn-sm btn-default ajax_page')); ?>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="col-lg-12 col-xs-12 col-md-12 col-sm-12">
		<div class="box box-solid box-primary">
			<div class="box-header">
				<h3 class="box-title"><?php echo __('Notices'); ?></h3>
				<div class="box-tools pull-right">
			...
			<div class="box-body">
				<div class="row">
						...
						<?php
							...
							echo $this->Form->input('image',array('type'=>'file','onchange'=>'displayImage(this,"avaterImage")','class'=>'','div'=>'form-group col-md-10'));
							echo $this->Form->input('category',array('type'=>'hidden','value'=>'admission','class'=>'form-control','div'=>'form-group col-md-3'));
							...
							echo $this->Form->input('is_marquee',array('type'=>'checkbox','class'=>'form-control','div'=>'form-group checkbox col-md-6'));
